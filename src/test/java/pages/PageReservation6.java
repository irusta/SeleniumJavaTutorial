...
public class PageReservation6 {
	...
	public PageReservation6(WebDriver driver) {
		this.driver = driver;
	...
	public void selectPassenger(int cant) {
		//vamos a poner un explicitwait a passengersDrop, para verificar que dicho elememto existe antes de ser seleccionado.
		WebDriverWait wait = new WebDriverWait(driver,10);
		WebElement cantidadPasajeros = wait.until(ExpectedConditions.presenceOfElementLocated(passengersDrop));
		Select selectPasajeros = new Select(cantidadPasajeros); //en este caso el elemento que hemos creado es del tipo Select
